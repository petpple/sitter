...
<head>
	...
	<link rel="stylesheet" href="/css/sitter/sitterMyPetInsert.css">
	<link rel="stylesheet" href="/css/main.css">
                ...
                <div class="col-lg-7">
		        	...
		        	<div class="box_miInfo">
		       			...
		       			<div class="form-inline">
		       				<form action="/sitter/petInsert" method="post" enctype="multipart/form-data">
						...
						<div class="form">
							<label for="floatingTextarea2">기타 참고사항</label><br>
								...
								<div class="col text-center">
				                   ...
				                   <!-- onclick="location.href='http://localhost:8093/sitter/sitterMyPet'" -->
				                   추가하기</button>
				                </div> 
