...
<script type="text/javascript">
	$(document).ready(function() {
		document.getElementById("serv_on").onload = function() {
			// 			  //실행될 코드
			alert("sadsa");
		}
	});
				...
				<div class="col-lg-7">
					...
					<div class="box_mi">
						<span class="badge font_black"
							style="background-color: rgb(225, 199, 199);">방문 서비스</span> <img
							src="/images/vsitter/timer-icon.svg" class="svgImg1"> <span
							id="remainTime" class="s_font"></span>
						<div class="serv_on" id="serv_on">
							
							<c:if test="${empty vsitterList }">
									<br>
									 <span class="text-center mb_font"> 현재 진행중인 펫시팅 서비스가 없습니다.</span>
							</c:if>
							<br>
							...
							<table class="table tab s_font align-middle">
								<tr>
									...
									<tr>
										<td><span class="reserveInfo">${vsitter.vid }</span></td>
										<td style="text-align: left;">
											<ul>

												<li>주소 : ${vsitter.addr }</li>
												<li>시작일자: ${vsitter.startDate }</li>
												<li>종료일자: ${vsitter.endDate }</li>
											</ul>
										</td>
										<td><div class="reservInfoTd">
												<img src="${vsitter.clientProfile }" style="width: 60px;"><br>
												<span class="mb_font">${vsitter.clientNickname }</span>
											</div></td>
										<td><fmt:formatNumber value="${vsitter.totalPrice }" /> 원
										</td>
										<span class="mb_font"> ${vsitter.service }</span>
									</tr>
								</c:forEach>
							</table>
							...
							<div>
								...
								<a href="http://localhost:8093/sitter/sitterDiaryPetChoice"><button
										type="button" class="btn btn-primary" style="">일지 쓰기</button></a>
							</div>
						</div>
					</div>
					<!-- 진행중인 펫시팅 긴급 - 방문 서비스 -->
					<div class="box_mi">
						<span class="badge font_black"
							style="background-color: rgb(225, 199, 199);">긴급 - 방문 서비스</span>
						<img src="/images/vsitter/timer-icon.svg" class="svgImg1"> <span
							id="remainTime" class="s_font"></span>
						<div class="serv_on">
							<table class="table tab s_font align-middle">
								<tr>
							...
							<table class="table tab s_font align-middle">
									...
									<td style="text-align: left;">
										<ul>
											<li><a href=""><span class="badge s_font font_black"
													style="background-color: rgb(225, 199, 199);">방문서비스</span></a>
											</li>
											<li>주소 : 서울특별시 강서구 화곡로 344 경동 에파이어 304호</li>
											<li>시작일자: 2022-12-12 10:00</li>
											<li>종료일자: 2022-12-12 13:00</li>
								...
								<tr>
									...
									<td style="text-align: left;">
										<ul>
											<li><a href=""><span class="badge s_font font_black"
													style="background-color: rgb(225, 199, 199);">긴급-위탁서비스</span></a>
											</li>
											<li>주소 : 서울특별시 강서구 화곡로 344 경동 에파이어 304호</li>
											<li>시작일자: 2022-12-12 10:00</li>
											<li>종료일자: 2022-12-12 13:00</li>
