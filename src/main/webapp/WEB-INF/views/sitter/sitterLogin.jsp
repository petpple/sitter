...
<link rel="stylesheet" href="/css/sitter/sitterLoginForm.css">
<link rel="stylesheet" href="/css/sitter/sMain.css">
					...
					<div class="box">
						<div class="tab_content">
							<input type="radio" name="tabmenu" id="tab01" checked> <label
								class="h2_font" for="tab01">방문펫시터</label> <input type="radio"
								name="tabmenu" id="tab02"> <label class="h2_font "
								for="tab02">위탁펫시터</label>
							<div class="conbox con1">
								...
								<form action="/sitter/loginAction" method="post" id="userForm">
									<div>
