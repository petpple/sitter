...
<body>
        ...
        <div class ="box_pi">
            ...
            <a href="http://localhost:8093/sitter/sitterInfoVsvcWaiting" class="side_aTag"><span class="s_font font_black">수락 대기중 : <span>${result1 }</span> 건</span></a><br>
            <a href="http://localhost:8093/sitter/sitterInfoVsvcPast" class="side_aTag"><span class="s_font font_black">지난 펫시팅 이력 : <span>${result2 }</span> 건</span></a><br>
        </div><br>
        <div class ="box_pi_money">
            ...
            <c:forEach var="vsitter" items="${vsitterList }">
            	<span class="font s_font">이번 달 수익금 : <fmt:formatNumber value="${vsitter.totalPrice }"/> 원</span><br>
            	<span class="font s_font">총 수익금 : <fmt:formatNumber value="${vsitter.totalPrice }"/> 원</span><br>
            </c:forEach>
        </div>
</body>
</html>